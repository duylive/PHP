...
$sql = "SELECT books.name, books.author, books.price, categories.name AS 'category_name', books.status FROM books JOIN categories ON books.category_id = categories.id";
$stmt = $conn->query($sql);
$books = $stmt->fetchAll();
